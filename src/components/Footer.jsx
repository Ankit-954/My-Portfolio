  ...
  return (
    ...
    <div className="text-center sm:flex items-center justify-between border-t border-gray-400 mx-[10%] mt-12 py-6">
        ...
        <ul className="flex items-center gap-10 justify-center mt-4 sm:mt-0">
            <li><a target='_blank' href="https://github.com/Ankit-954">GitHub</a></li>
            <li><a target='_blank' href="https://www.linkedin.com/in/ankit-kumar-5669042aa/">LinkedIn</a></li>
            <li><a target='_blank' href="https://www.instagram.com/_ankitmishra3470/?next=%2F&hl=en">Instagram</a></li>
        </ul>
    </div>
 </div>
  )
