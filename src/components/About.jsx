  ...
  return (
    ...
    <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
            <p className="mb-10 max-w-2xl font-Ovo">I am a fullstack developer with experience in building dynamic web applications using modern technologies. 
             in front-end development with React, Tailwind CSS, and backend technologies like Node.js and Express.</p>
