      ...
      <div className="grid grid-cols-auto my-10 gap-5 dark:text-black">
        <div className="aspect-square bg-[url('./assets/work-1.png')] bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group">
          <div className="bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
            <a
              href="https://food-delivery-frontend-rhfc.onrender.com"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div>
                <h2 className="font-semibold">Food Delivery</h2>
                <p className="text-sm text-gray-700">Fullstack Project</p>
              </div>
            </a>
        ...
        <div className="aspect-square bg-[url('./assets/work-2.png')] bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group">
          <div className="bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
            <a
              href="https://weather-app-opal-nu-53.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div>
                <h2 className="font-semibold">Weather Project</h2>
                <p className="text-sm text-gray-700">Frontend Api Project</p>
              </div>
            </a>
        ...
        <div className="aspect-square bg-[url('./assets/work-3.png')] bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group">
          <div className="bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
            <a
              href="https://bakery-react-app.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div>
                <h2 className="font-semibold">Bakery App</h2>
                <p className="text-sm text-gray-700">Frontend Project</p>
              </div>
            </a>
        ...
        <div className="aspect-square bg-[url('./assets/work-4.png')] bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group">
          <div className="bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
            <a
              href="https://uni-health-care.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div>
                <h2 className="font-semibold">Doctor Booking</h2>
                <p className="text-sm text-gray-700">Frontend Project</p>
              </div>
            </a>
